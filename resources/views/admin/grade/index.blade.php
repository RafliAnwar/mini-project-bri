                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <a href="{{ route('admin.grade.create') }}" class="btn btn-primary text-bold">+ Kelas</a>
                        </div>
                    </div>
                                    ...
                                    @foreach ($grades as $grade)
                                        <tr>
                                            ...
                                            <td class="flex-row d-flex">
                                                <a href="{{ route('admin.grade.edit', Crypt::encryptString($grade->id)) }}"
                                                    class="btn btn-secondary">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <form method="post"
                                                    action="{{ route('admin.grade.destroy', $grade->id) }}">
                                                    @method('delete')
                                                    @csrf
...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            $('#grade').on('click', '.delete-btn', function(e) {
                e.preventDefault();
